...
file_path = "learnwell_dataset.xlsx"
engine = "openpyxl"
...
def welcome():
    ...
    #return page and values
    return render_template('welcome.html', learningpercent = learning_percent, \
                           supportpercent = support_percent, competencepercent = competence_percent, \
                            fillerpercent = filler_percent, self_ef_percent = self_ef_percent, psy_flex_percent = psy_flex_percent, \
                                burnoutpercent = burnoutpercent, selfrefpercent = selfrefpercent)
